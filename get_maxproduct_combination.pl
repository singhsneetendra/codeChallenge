...
sub main {
  ...
  print "MAXIMUM VALUE - " . $max_product . "\n";
...
sub get_max_product {
  ...
  return ( $max_product_row_column >= $max_product_diagonaly ) ? $max_product_row_column : $max_product_diagonaly;
}
...
sub set_if_defined {
  ...
  my $value = shift;
  ( defined $value ) ? return $value : return 1;

}

sub multiply_four_numbers {
